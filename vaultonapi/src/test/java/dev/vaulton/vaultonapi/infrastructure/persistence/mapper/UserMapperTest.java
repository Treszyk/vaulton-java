...
class UserMapperTest {
  ...
  void shouldMapUserEntityToDomain() {
    ...
    assertAll(
        ...
        () ->
            assertArrayEquals(
                testUser.getSaltAdminVerifier(), mappedUser.getSaltAdminVerifier().bytes()),
        ...
        () ->
            assertArrayEquals(
                testUser.getMkWrapPwd().cipherText(),
                mappedUser.getMkWrapPwd().cipherText().bytes()),
        () ->
            assertArrayEquals(
                testUser.getMkWrapPwd().tag(), mappedUser.getMkWrapPwd().tag().bytes()));
  }
  ...
  void shouldMapDomainUserToEntity() {
    ...
    assertAll(
        ...
        () ->
            assertArrayEquals(
                testUser.getSaltAdminVerifier().bytes(), mappedUser.getSaltAdminVerifier()),
        ...
        () ->
            assertArrayEquals(
                testUser.getMkWrapPwd().cipherText().bytes(),
                mappedUser.getMkWrapPwd().cipherText()),
        () ->
            assertArrayEquals(
                testUser.getMkWrapPwd().tag().bytes(), mappedUser.getMkWrapPwd().tag()));
  }
