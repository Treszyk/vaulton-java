...
/**
 * A Value Object wrapping a byte array with controlled zeroization (wiping) capabilities. Performs
 * defensive cloning on both intake and output to prevent reference leakage while allowing for safe
