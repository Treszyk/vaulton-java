...
/**
 * Global constants defining the cryptographic specifications for the system. These values ensure
 * consistency between the Java backend and the Angular client, specifically regarding key lengths,
 * salts, and AES-GCM parameters.
 */
